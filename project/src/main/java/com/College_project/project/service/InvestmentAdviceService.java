...
public class InvestmentAdviceService {
    ...
    public InvestmentAdviceResponse getInvestmentAdvice(Long userId, InvestmentAdviceRequest request) {
        ...
        response.setMethodUsed("RULE");
        response.setMethodDetails("Generated by the built-in rule engine using risk tolerance, horizon, savings, goal, and existing investment data.");
